...
Key components:
- CacheBlock: Metadata for each cache block with doubly linked list pointers
...
- PagedCache: Main manager with block allocation, prefix caching, and COW
...
# =============================================================================
# CacheBlock - Following vLLM's design
# =============================================================================
...
# =============================================================================
# PagedCache - Main manager (vLLM BlockPool style)
# =============================================================================
...
class PagedCache:
    ...
    def __init__(
        ...
        logger.info(
            f"PagedCache initialized: block_size={block_size}, "
    ...
    def clear(self) -> None:
        ...
        with self._lock:
            ...
            logger.info("PagedCache cleared")
