...
"""
MLLM (Multimodal Language Model) Cache.
...
MLLMPrefixCacheEntry = MLLMCacheEntry
...
class MLLMCache:
    """
    LRU Cache for MLLM prefix states with vision embedding caching.
    ...
    Example:
        >>> cache = MLLMCache(max_memory_mb=2048)
    ...
    def __init__(
        ...
        self._cache: OrderedDict[str, MLLMCacheEntry] = OrderedDict()
    ...
    def __repr__(self) -> str:
        ...
        return f"<MLLMCache entries={len(self)} memory={mem_mb:.1f}MB>"
...
VLMPrefixCacheEntry = MLLMCacheEntry
VLMCacheEntry = MLLMCacheEntry
VLMPrefixCacheManager = MLLMCache
VLMCacheManager = MLLMCache